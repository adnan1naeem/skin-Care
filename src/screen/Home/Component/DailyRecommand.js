...
const DailyRecommand = ({ image1, text, description, ButtonText,OnPress,DailyRoutine,AnalyzeButton,Id }) => {
  return (
      ...
      <View style={{ flex: 1, flexDirection: 'row' }}>
        ...
        <View style={styles.button_container}>
         {DailyRoutine===true && Id==2 ? <View style={styles.completeButton} onPress={OnPress}>
            <Text style={styles.completeText} numberOfLines={2}>Done</Text>
          </View>:(
            AnalyzeButton===true && Id==1?<View style={styles.completeButton} onPress={OnPress}>
            <Text style={styles.completeText} numberOfLines={2}>Done</Text>
          </View>:
           <TouchableOpacity style={styles.button} onPress={OnPress}>
           <Text style={styles.buttontext} numberOfLines={2}>{ButtonText}</Text>
         </TouchableOpacity>
          )
          }
        </View>
